...
public class ValidadorVemTest {
    ...
    public static void exibirValidacao(validador.ValidadorVem cartaoVem, String titulo) {
        ...
        System.out.println("==============================");
        System.out.println("Cartão Nº:...................: " + cartaoVem.getNumeroCartao());
        System.out.printf("Tarifa do Ônibus:............: R$ %.2f%n", cartaoVem.getTarifa());
        System.out.printf("Saldo Anterior:..............: R$ %.2f%n", cartaoVem.getSaldo());

        System.out.print("Status:......................: ");
        cartaoVem.pagarPassagem();

        System.out.printf("Saldo Atualizado:............: R$ %.2f%n", cartaoVem.getSaldo());
        System.out.println();
    }
}